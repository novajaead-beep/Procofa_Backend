...
/// <summary>
/// Implementación de <see cref="IRefreshTokenFactory"/>: <see cref="RandomNumberGenerator"/> (nunca
/// <see cref="Random"/>) para el valor crudo, SHA-256 para el hash persistido. El valor crudo se
/// codifica Base64Url (sin relleno) para que viaje limpio en JSON/headers sin caracteres que
/// requieran escape. </summary>
